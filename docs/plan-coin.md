...
- [ ] `t_0717_2106_c35672ba` Remediasi gate: Author EconomyGateTests.cs dengan test missing-script untuk keempat scene retrofit
- [ ] `t_0717_2106_73b0a24f` Remediasi gate: Wire ShopSceneBuilder.Build() ke SkeletonBuilder.BuildAll() dan verifikasi output Shop.unity
- [ ] `t_0717_2106_dcc0753c` Remediasi gate: Ganti kriteria idempotency BuildAll dari raw git diff ke pembanding semantik scene
