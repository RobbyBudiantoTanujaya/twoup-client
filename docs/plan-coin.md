...
- [ ] `t_0717_2143_e31e3c22` Remediasi gate: Rework SkeletonBuilder dan semua SceneBuilder menjadi idempotent in-place (find-or-create, bukan Destroy+Instantiate)
