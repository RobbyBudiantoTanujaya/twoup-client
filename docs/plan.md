...
- [x] `t_0716_1527_bc1cd8c7` Remediasi gate: Buat laporan gate visual docs/gate-visual-report.md dengan tabel verifikasi per-scene
...
- [x] `t_0716_0035_59367503` Retire Lobby - hapus scene, controller, builder
- [x] `t_0716_0035_1f3fd1bd` Scene InviteRoom (S3)
- [x] `t_0716_0035_084b36c7` Scene Queue (S4)
- [x] `t_0716_0035_5778be3a` Scene Voting (S5) + bot picker
...
- [x] `t_0716_0035_a68f8c0d` Scene Settings (S10)
- [x] `t_0716_0035_023a20a9` Extend scene ConnectFour - turn timer ring, emote wheel, jalur async
- [x] `t_0716_0035_dbdd042f` Scene AirHockey (S6-AH)
- [x] `t_0716_0035_09be9778` Scene ReflexDuel (S6-RD)
- [x] `t_0716_0035_5e5491c1` Scene WallDefense (S6-WD)
- [x] `t_0716_0035_a1a7f548` Scene KeepUpDuo (S6-KU)
...
- [ ] `t_0716_1541_3a7b0e16` Fix checkpoint: GATE AKHIR - APK build hijau (siklus 1/4)
